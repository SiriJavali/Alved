...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: 0bcOsZ-dkYdg/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__uMsu9)}>
            <PlasmicImg__
          ...
          <div className={classNames(projectcss.all, sty.column__e5ImD)}>
            <h5
