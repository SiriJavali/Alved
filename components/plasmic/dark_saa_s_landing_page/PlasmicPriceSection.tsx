...
import sty from "./PlasmicPriceSection.module.css"; // plasmic-import: X4jPiVsfkDkL/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__wEXjO)}
      >
        <div className={classNames(projectcss.all, sty.freeBox___10Em9)}>
          <PriceCard
            borders={["flatLeft"]}
            className={classNames("__wab_instance", sty.priceCard__wV3Rq)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__kl0Fg)}>
          <div className={classNames(projectcss.all, sty.freeBox___9WkVh)}>
            <div
          ...
          <PriceCard
            borders={["flatCenter"]}
            className={classNames("__wab_instance", sty.priceCard__nph1U)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__eqKnO)}>
          <PriceCard
            borders={
            ...
            className={classNames("__wab_instance", sty.priceCard__sqTki)}
          />
        </div>
      </Stack__>
    </div>
