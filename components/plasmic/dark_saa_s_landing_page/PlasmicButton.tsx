...
import sty from "./PlasmicButton.module.css"; // plasmic-import: mDqPQunCKBZT/css
    ...
    >
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__vBMlY)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__hqGs4)}
                role={"img"}
              />
            ),
