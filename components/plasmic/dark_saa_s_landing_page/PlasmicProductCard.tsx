...
import sty from "./PlasmicProductCard.module.css"; // plasmic-import: QjAs3RKQce-n/css
...
function PlasmicProductCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__uYA)}>
        <PlasmicImg__
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/dark_saa_s_landing_page/images/siriDesignASleekAndFuturisticLogoForAlvedAB73Fa3CbC3D648B09C5F491387D16Bc4Png.jpg",
            fullWidth: 1024,
            fullHeight: 1024,
        ...
        >
          {hasVariant(globalVariants, "screen", "mobileOnly")
            ...
            : "Provide drag-and-drop functionality for adding generated elements directly to the timeline."}
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__le1X)} />
      </div>
    </div>
